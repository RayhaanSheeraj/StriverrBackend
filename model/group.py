...
def initGroups():
    ...
    with app.app_context():
        ...
        striver_section = Section.query.filter_by(_name='Striver').first()
        groups = [
            Group(name='Achievements', section_id=striver_section.id, moderators=[User.query.get(1)]),
            Group(name='Challenges', section_id=striver_section.id, moderators=[User.query.get(1)]),
        ]
