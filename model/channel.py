...
def initChannels():
    ...
    with app.app_context():
        ...
        achievements = Group.query.filter_by(_name='Achievements').first()
        challenges = Group.query.filter_by(_name='Challenges').first()
        striver_challenges = [
        ...
        channels = home_page_channels + striver_challenges
